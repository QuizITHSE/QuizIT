...
12. Запускается Сценарий 8 - Просмотр результатов и работа над ошибками Учеником.

### [ Сценарий 8 - Просмотр результатов и работа над ошибками Учеником ]

1.  После LIVE-викторины или ДЗ: Ученику становится доступен его результат (баллы, процент правильных ответов, затраченное время).
2.  Ученик может перейти к детальному разбору:
    *   Текст вопроса.
    *   Ответ ученика.
    *   Указание, был ли ответ правильным.
    *   Правильный ответ.
    *   Пояснение к правильному ответу (если было добавлено учителем).
3.  Система может предлагать материалы для работы над ошибками по темам, где были допущены ошибки.
4.  Ученик видит свой прогресс в личном кабинете.

### [ Сценарий 9 - Управление успеваемостью, анализ результатов и экспорт Учителем ]

1.  Учитель заходит в панель управления классом или в раздел "Результаты".
2.  Учитель выбирает конкретную проведенную LIVE-викторину или назначенное ДЗ.
3.  Отображается сводная статистика:
    *   Средний балл/процент правильных ответов.
    *   Список учеников с их индивидуальными результатами:
        *   Баллы/процент правильных ответов.
        *   Время, затраченное на выполнение.
        *   Статус (завершено, не начато, просрочено, завершено с нарушением из-за Lockdown).
        *   Количество зафиксированных переключений вкладок (если отслеживалось).
4.  Учитель может посмотреть детальные ответы каждого ученика.
5.  Система предоставляет аналитику по вопросам (сложность, частые ошибки).
6.  Учитель имеет возможность экспортировать результаты (общие и/или индивидуальные) в форматы XLS и CSV.
7.  На основе анализа учитель планирует дальнейшую работу.
8.  Запускается Сценарий 10 - Выдача персонализированных домашних заданий.
